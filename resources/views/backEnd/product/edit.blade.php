                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="stock" class="form-control{{ $errors->has('stock') ? ' is-invalid' : '' }}" value="{{$edit_data->stock}}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="price" class="form-control{{ $errors->has('stock') ? ' is-invalid' : '' }}" value="{{$edit_data->price}}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" class="form-control{{ $errors->has('stock') ? ' is-invalid' : '' }}" value="{{$edit_data->contact}}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group custom-textarea">
                                ...
                                <textarea name="description" class="textarea form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" value="{{ old('description') }}">{{$edit_data->description}}</textarea>
